        ...
        {allScores
          ...
          .map((d, i) => (
            ...
            >
              ...
              {show === i && (
                <div className="w-full text-left text-yellow-500">
                  <div className="border-b border-yellow-500 flex">
                  ...
                  <div>
                    ...
                    <div className="flex justify-end">
                      <div className="ml-auto px-2 py-1 text-xs text-gray-100 m-2 rounded-xl ">
