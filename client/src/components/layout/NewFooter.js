...
const NewFooter = () => {
  return (
    <div className="bg-gray-800 text-green-500 py-4 flex flex-col items-center justify-center f-f-l">
      ...
      <div></div>
      <div className="pt-2 flex lg:items-start items-center">
        <p className="lg:text-base text-xs text-green-500 leading-5">
          2021 Conor Walsh
        </p>
      </div>
    </div>
